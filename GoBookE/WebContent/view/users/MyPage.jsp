        ...
        <div class="container">
          <div class="row">
            <div class="col-xs-5 contact">
              <p class="hidden-sm hidden-xs">Contact us on +420 777
                555 333 or hello@universal.com.</p>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="dropdown active"><a
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="index.html">Option 1: Default
                        Page</a></li>
                    <li><a href="index2.html">Option 2:
                        Application</a></li>
                    <li><a href="index3.html">Option 3: Startup</a>
                    </li>
                    <li><a href="index4.html">Option 4: Agency</a>
                    </li>
                    <li><a href="index5.html">Option 5:
                        Portfolio</a></li>
                  </ul></li>
                            ...
                            <ul>
                              ...
                              <li><a
                                href="template-content-boxes.html">Content
                                  boxes</a></li>
                              <li><a href="template-blocks.html">Horizontal
                                  blocks</a></li>
                              <li><a
                ...
                <li class="dropdown use-yamm yamm-fw"><a href="#"
                  class="dropdown-toggle" data-toggle="dropdown">Portfolio
                    <b class="caret"></b>
                </a>
                  <ul class="dropdown-menu">
                    <li>
                          ...
                          <div class="col-sm-3">
                            ...
                            <ul>
                              ...
                              <li><a href="portfolio-detail.html">Portfolio
                                  - detail</a></li>
                              <li><a href="portfolio-detail-2.html">Portfolio
                                  - detail 2</a></li>
                            </ul>
                          </div>
                          <div class="col-sm-3">
                            ...
                            <ul>
                              ...
                              <li><a href="team-member.html">Team
                                  member</a></li>
                      ...
                      <div class="yamm-content">
                        <div class="row">
                          <div class="col-sm-3">
                            <h5>Home</h5>
                            <ul>
                              <li><a href="index.html">Option
                                  1: Default Page</a></li>
                              <li><a href="index2.html">Option
                                  2: Application</a></li>
                              <li><a href="index3.html">Option
                                  3: Startup</a></li>
                              <li><a href="index4.html">Option
                                  4: Agency</a></li>
                              <li><a href="index5.html">Option
                                  5: Portfolio</a></li>
                            </ul>
                            <h5>About</h5>
                            <ul>
                          ...
                          <div class="col-sm-3">
                            ...
                            <ul>
                              <li><a href="customer-register.html">Register
                                  / login</a></li>
                              <li><a href="customer-orders.html">Orders
                                  history</a></li>
                              <li><a href="customer-order.html">Order
                                  history detail</a></li>
                          ...
                          <div class="col-sm-3">
                            ...
                            <ul>
                              ...
                              <li><a href="shop-category-full.html">Category
                                  - full width</a></li>
                              <li><a href="shop-detail.html">Product
                                  detail</a></li>
                            </ul>
                            <h5>Shop - order process</h5>
                            <ul>
                              <li><a href="shop-basket.html">Shopping
                                  cart</a></li>
                              <li><a href="shop-checkout1.html">Checkout
                                  - step 1</a></li>
                              <li><a href="shop-checkout2.html">Checkout
                                  - step 2</a></li>
                              <li><a href="shop-checkout3.html">Checkout
                                  - step 3</a></li>
                              <li><a href="shop-checkout4.html">Checkout
                                  - step 4</a></li>
                            </ul>
                          </div>
                          <div class="col-sm-3">
                            ...
                            <ul>
                              ...
                              <li><a href="contact2.html">Contact
                                  - version 2</a></li>
                              <li><a href="contact3.html">Contact
                                  - version 3</a></li>
                            </ul>
                            <h5>Pages</h5>
                            <ul>
                              ...
                              <li><a href="text-left.html">Text
                                  page - left sidebar</a></li>
                              <li><a href="text-full.html">Text
                            ...
                            <ul>
                              <li><a href="blog.html">Blog
                                  listing big</a></li>
                              <li><a href="blog-medium.html">Blog
                                  listing medium</a></li>
                              <li><a href="blog-small.html">Blog
                                  listing small</a></li>
                ...
                <li class="dropdown"><a href="javascript: void(0)"
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="contact2.html">Contact option
                        2</a></li>
                    <li><a href="contact3.html">Contact option
                        3</a></li>
...
_________________________________________________________ -->
          ...
          <div class="modal-body">
            ...
            <p class="text-center text-muted">
              <a href="customer-register.html"><strong>Register
                  now</strong></a>! It is easy and done in 1&nbsp;minute and gives
              you access to special discounts and much more!
            </p>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-9">
            ...
            <p class="text-muted lead">In our Ladies department we
              offer wide selection of the best products we have found
              and carefully selected worldwide. Pellentesque habitant
              morbi tristique senectus et netuss.</p>
            ...
            <div class="row products">
              ...
              <div class="col-md-4 col-sm-6">
                <div class="product">
                  ...
                  <div class="text">
                    <h3>
                      <a href="shop-detail.html">Fur coat with very
                        but very very long name</a>
                    </h3>
                    <p class="price">$143.00</p>
                    <p class="buttons">
                      <a href="shop-detail.html" class="btn btn-default">View
                        detail</a> <a href="shop-basket.html"
                        class="btn btn-template-main"><i
              ...
              <div class="col-md-4 col-sm-6">
                <div class="product">
                  ...
                  <div class="text">
                    <h3>
                      <a href="shop-detail.html">Black Blouse
                        Versace</a>
                    </h3>
                    <p class="price">$143.00</p>
                    <p class="buttons">
              ...
              <div class="col-md-4 col-sm-6">
                <div class="product">
                  ...
                  <div class="text">
                    <h3>
                      <a href="shop-detail.html">White Blouse
                        Versace</a>
                    </h3>
                    <p class="price">$143.00</p>
                    <p class="buttons">
            ...
            <div class="row">
              ...
              <div class="col-md-12 banner">
                <a href="#"> <img src="/img/banner2.jpg" alt=""
            ...
            <div class="pages">
              ...
              <p class="loadMore">
                <a href="#" class="btn btn-template-main"><i
            ...
            <div class="panel panel-default sidebar-menu">
              ...
              <div class="panel-body">
                <ul class="nav nav-pills nav-stacked category-menu">
                    ...
                    <ul>
                      <li><a href="shop-category.html">구매내역</a>
                      </li>
                      <li><a href="shop-category.html">개인정보수정</a></li>
                      </li>
                    </ul></li>
 ...
 <!--           <div class="banner">
              <a href="shop-category.html"> <img
                src="/img/banner.jpg" alt="sales 2014"
                class="img-responsive">
              </a>
            </div>
             -->
...
_________________________________________________________ -->
    ...
    <div id="copyright">
      <div class="container">
        <div class="col-md-12">
          <p class="pull-left">&copy; 2015. Your company / name goes
            here</p>
          <p class="pull-right">
  ...
  <script src="/js/users/jquery.cookie.js"></script>
  <script src="/js/users/waypoints.min.js"></script>
  <script src="/js/users/jquery.counterup.min.js"></script>
  <script src="/js/users/jquery.parallax-1.1.3.js"></script>
  <script src="/js/users/front.js"></script>
