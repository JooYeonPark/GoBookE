  ...
  <div class="container">
    ...
    <div class="col-md-12">
      ...
      <p class="lead">
        ...
        est. Mauris placerat eleifend leo. <span class="accent">Check
          our blog!</span>
      </p>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="box-image-text blog">
            ...
            <div class="content">
              ...
              <p class="intro">Fifth abundantly made Give sixth
                hath. Cattle creature i be don't them behold green moved
        ...
        <div class="col-md-3 col-sm-6">
          <div class="box-image-text blog">
            ...
            <div class="content">
              ...
              <p class="intro">Am terminated it excellence
                invitation projection as. She graceful shy believed
                distance use nay. Lively is people.</p>
              <p class="read-more">
                <a href="blog-post.html" class="btn btn-template-main">Continue
                  reading</a>
              </p>
