...
_________________________________________________________ -->
    ...
    <div id="content">
      <div class="container">
        <div class="row">
          <div class="box">
            <h2 class="text-uppercase" align="center">회원가입</h2>

            <hr>

            <form action="customer-orders.html" method="post">
              <div class="form-group">
                <label for="id-login">아이디</label> <input type="text"
                  class="form-control" id="name-login">
              </div>
              <div class="form-group">
                <label for="password-login">비밀번호</label> <input
                  type="password" class="form-control"
                  id="password-login">
              </div>
              <div class="form-group">
                <label for="password2-login">비밀번호 확인</label> <input
                  type="password" class="form-control"
                  id="password2-login">
              </div>
              <div class="form-group">
                <label for="name-login">이름</label> <input type="text"
                  class="form-control" id="name-login">
                <div class="form-group">
                  <div class="form-group">
                    <label for="name-login">핸드폰번호</label> <input
                      type="text" class="form-control" id="name-login">
                    <div class="form-group">
                      <label for="email-login">이메일</label> <input
                        type="text" class="form-control"
                        id="email-login">
                    </div>
                    <div class="form-group">
                      <label for="email-login">주소</label> <input
                        type="text" class="form-control"
                        id="email-login">
                    </div>
                    <div class="form-group">
                      <label for="email-login">상세주소</label> <input
                        type="text" class="form-control"
                        id="email-login">
                    </div>
